...
namespace App_movie_mvc.Data
{
    public class DbSeeder
    {
        public static async Task Seed(MovieDbContext context, UserManager<Usuario> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            if (context.Pelicula.Any() || context.Plataformas.Any() || context.Genero.Any())
                return;
            ...
            var plataformas = new List<Plataforma>
    {
        new Plataforma {
            ...
            UrlLogo = "https://upload.wikimedia.org/wikipedia/commons/0/08/Netflix_2015_logo.svg"
        },
        new Plataforma {
            Nombre = "Prime Video",
            Url = "https://www.primevideo.com",
            UrlLogo = "https://upload.wikimedia.org/wikipedia/commons/6/6d/Prime_Video_logo_%282024%29.svg"
        },
        new Plataforma {
            Nombre = "Disney+",
            Url = "https://www.disneyplus.com",
            UrlLogo = "https://upload.wikimedia.org/wikipedia/commons/3/3e/Disney%2B_logo.svg"
        },
        new Plataforma {
            Nombre = "Max",
            Url = "https://www.max.com",
            UrlLogo = "https://upload.wikimedia.org/wikipedia/commons/0/0a/Max_logo.svg"
        }
    };
    ...
    {
        new Genero { Descipcion = "Acción" },
        new Genero { Descipcion = "Drama" },
        new Genero { Descipcion = "Comedia" },
        new Genero { Descipcion = "Ciencia Ficción" },
        new Genero { Descipcion = "Animación" }
    };
            ...
            var g = generos.ToDictionary(x => x.Descipcion);
            ...
            var peliculas = new List<Pelicula>
    {
        ...
        new Pelicula {
            ...
            MinutosDuracion = 209,
            PosteUrlPortada = "https://m.media-amazon.com/images/M/MV5BYjRiMzYyNjItZmMwMy00ZGIwLWE2NDktMjcxYTM3MTE2ODhhXkEyXkFqcGc@._V1_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 124,
            PosteUrlPortada = "https://m.media-amazon.com/images/M/MV5BMjAzMTI1MjMyN15BMl5BanBnXkFtZTgwNzU5MTE2NjM@._V1_FMjpg_UX1000_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 129,
            PosteUrlPortada = "https://mx.web.img2.acsta.net/pictures/22/07/18/22/06/0534391.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 106,
            PosteUrlPortada = "https://es.web.img3.acsta.net/pictures/22/03/01/15/19/5343614.jpg",
            Genero = g["Ciencia Ficción"], Plataforma = p["Netflix"]
        },
        new Pelicula {
            ...
            MinutosDuracion = 117,
            PosteUrlPortada = "https://es.web.img2.acsta.net/pictures/22/10/19/12/15/3740227.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 138,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/6/60/The_Tomorrow_War_%282021_film%29_official_theatrical_poster.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 120,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/1/11/Sound_of_Metal_poster.jpeg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 114,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/8/87/One_Night_in_Miami_poster.jpeg",
            Genero = g["Drama"], Plataforma = p["Prime Video"]
        },
        new Pelicula {
            Titulo = "Air",
            ...
            MinutosDuracion = 112,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/d/de/AirFilmPoster.png",
            Genero = g["Drama"], Plataforma = p["Prime Video"]
        },
        new Pelicula {
            ...
            MinutosDuracion = 137,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/d/de/Manchester_by_the_Sea.jpg",
            Genero = g["Drama"], Plataforma = p["Prime Video"]
        },
        ...
        new Pelicula {
            ...
            FechaLanzamiento = new DateTime(2020, 12, 25),
            MinutosDuracion = 101,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/3/39/Soul_%282020_film%29_poster.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 95,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/3/33/Luca_%282021_film%29.png",
            Genero = g["Animación"], Plataforma = p["Disney+"]
        },
        new Pelicula {
            Titulo = "Turning Red",
            ...
            FechaLanzamiento = new DateTime(2022, 3, 11),
            MinutosDuracion = 100,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/9/9e/Turning_Red_poster.jpg",
            Genero = g["Animación"], Plataforma = p["Disney+"]
        },
        new Pelicula {
            ...
            MinutosDuracion = 104,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/f/f4/Hocus_Pocus_2_Logo.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 119,
            PosteUrlPortada = "https://upload.wikimedia.org/wikipedia/en/9/93/Disenchanted.jpg",
            Genero = g["Comedia"], Plataforma = p["Disney+"]
        },
        ...
        new Pelicula {
            ...
            MinutosDuracion = 242,
            PosteUrlPortada = "https://m.media-amazon.com/images/M/MV5BNDA0MzM5YTctZTU2My00NGQ5LWE2NTEtNDM0MjZmMDBkOTZkXkEyXkFqcGc@._V1_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 115,
            PosteUrlPortada = "https://m.media-amazon.com/images/M/MV5BODRhMzgyOWMtNzRhNS00YTkwLWJiMDgtYjQzZWQ3MTA3NmUwXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 104,
            PosteUrlPortada = "https://m.media-amazon.com/images/M/MV5BMTIyMjc0MzQtMTdiZi00YzE4LWJhNGMtMWIwYjM5Yzc1ZGM3XkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 92,
            PosteUrlPortada = "https://m.media-amazon.com/images/M/MV5BMzRmN2Q2NmYtODAxMi00OGZmLWIyODAtMjU0ZDVmNGNiY2EyXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
            Genero = g["Drama"], Plataforma = p["Max"]
        },
        new Pelicula {
            ...
            MinutosDuracion = 106,
            PosteUrlPortada = "https://m.media-amazon.com/images/M/MV5BYTNkOGQ4YmUtZGI1MS00N2EzLTkxMzMtMDk2ZTg0OTkyNWEwXkEyXkFqcGc@._V1_.jpg",
            Genero = g["Comedia"], Plataforma = p["Max"]
        }
    };

            context.Pelicula.AddRange(peliculas);
            context.SaveChanges();
        }

        internal static void Seed(MovieDbContext context)
        {
