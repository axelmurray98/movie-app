...
public class PlataformaController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Id,Nombre,Url,UrlLogo,PeliculaPlataforma")] Plataforma plataforma)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("Id,Nombre,Url,UrlLogo,PeliculaPlataforma")] Plataforma plataforma)
    {
        if (id != plataforma.Id)
        {
            return NotFound();
